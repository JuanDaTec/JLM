...
class Productos extends Controllers
{
    ...
    {
        if ($_POST) {
            if(empty($_POST['txtNombre']) || empty($_POST['txtCodigo']) || empty($_POST['listCategoria']) || empty($_POST['txtPrecio']) ) {
                ...
                if($request_producto > 0)
                {
                    ...
                    $arrResponse = array('status' => false, 'msg' => '¡Atención! Ya existe un producto con el código ingresado, verifica nuevamente.');
                }else{
