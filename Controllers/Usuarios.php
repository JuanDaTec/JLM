<?php
    class Usuarios extends Controllers{
		...
		{
			$data['page_tag'] = "Perfil de usuario | JLM";
		...
		public function putDFact(){
			if($_POST){
				if(empty($_POST['txtNit']) || empty($_POST['txtNombreFact']) || empty($_POST['txtDirFact']) )
				{
					$arrResponse = array("status" => false, "msg" => 'Datos incorrectos.');
				}else{
					$idUsuario = $_SESSION['idUser'];
					...
					$request_datafact = $this->model->updateDataFact($idUsuario,
																		$strNit,
																		$strNomFact, 
																		$strDirFact);
					if($request_datafact)
