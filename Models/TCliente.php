...
trait TCliente{
	...
	public function insertPedido(string $idtransaccionpaypal = NULL, string $datospaypal = NULL, int $personaid, float $costo_envio, string $monto, string $tipopagoid, string $direccionenvio, string $status){
		$this->con = new Mysql();
