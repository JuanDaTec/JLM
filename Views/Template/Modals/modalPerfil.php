    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="tile">
                    <h3 class="tile-title" id="titleModal">Actualizar datos</h3>
                    <div class="tile-body">
                        <form id="formPerfil" name="formPerfil" class="form-horizontal">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="txtIdentificacion">N° de cedula <span class="required">*</span></label>
                            ...
                            <div class="tile-footer">
                                <button id="btnActionForm" class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fas fa-save"></i><span id="btnText">Actualizar</span></button>&nbsp;&nbsp;&nbsp;
