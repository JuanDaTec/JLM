		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-6 p-b-50">
					...
					<div class="p-t-27">
						<a href="https://www.facebook.com/" target="blank" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados | Sitio realizado con fines educativos por parte del Servicio Nacional de Aprendizaje (SENA - CSF) para el establecimiento comercial <i class="fa fa-heart-o" aria-hidden="true"></i> JLM
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
