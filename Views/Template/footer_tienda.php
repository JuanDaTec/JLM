		...
		<div class="row">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					</script> Todos los derechos reservados | Sitio realizado con fines educativos por parte del Servicio Nacional de Aprendizaje (SENA - CSF) para el establecimiento comercial <i class="fa fa-heart-o" aria-hidden="true"></i> JLM
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
